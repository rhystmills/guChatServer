...
var setTokenOnUser = function (emailAddress, token) {
...
var generatePasswordResetToken = function (options, _a) {
    var resolve = _a.resolve, reject = _a.reject;
    return __awaiter(void 0, void 0, void 0, function () {
        var token, exception_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, setTokenOnUser(options.emailAddress, token)];
                case 1:
                    _b.sent();
                    resolve(token);
                    return [3 /*break*/, 3];
                case 2:
                    exception_1 = _b.sent();
                    reject("[generatePasswordResetToken] ".concat(exception_1.message));
                    return [3 /*break*/, 3];
...
export default (function (options) {
    return new Promise(function (resolve, reject) {
        generatePasswordResetToken(options, { resolve: resolve, reject: reject });
    });
});
