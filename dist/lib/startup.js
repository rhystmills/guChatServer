...
var handleProcessEvents = function () {
    try {
        ...
        process.on("unhandledRejection", function (error) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                logger.error(error);
                console.warn(error);
                return [2 /*return*/];
...
var startup = function (options, _a) {
...
export default (function (options) {
    return new Promise(function (resolve, reject) {
        startup(options, { resolve: resolve, reject: reject });
    });
});
