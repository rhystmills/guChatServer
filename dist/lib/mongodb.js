...
var cleanupMongoDBProcess = function () {
...
var getConnectionOptions = function () {
    var _a;
    try {
        var mongodbSettings = (_a = settings === null || settings === void 0 ? void 0 : settings.databases) === null || _a === void 0 ? void 0 : _a.mongodb;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!(!process.mongodb && connectionOptions)) return [3 /*break*/, 2];
                return [4 /*yield*/, MongoClient.connect(connectionOptions.uri, __assign({ useNewUrlParser: true, useUnifiedTopology: true, ssl: process.env.NODE_ENV === "production" }, connectionOptions.options))];
            case 1:
                mongodb = _a.sent();
