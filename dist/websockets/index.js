...
export default (function (expressServer) { return __awaiter(void 0, void 0, void 0, function () {
    var websocketServer, requestCallback, onConnection;
    return __generator(this, function (_a) {
        ...
        requestCallback = function (requestBuffer) {
            var request = JSON.parse(JSON.parse(requestBuffer));
